...
async function getMixpanelData(objParameters,funcResolve,funcReject) {
    ...
    getIDPromise.then(
      function(objReturnID) {
        ...
        var objReturn = {"rtn":"error", "rtnmsg":"unknown error","rtnstack":[]};
        objReturn.rtn = "ok";
        objReturn.rtnmsg = "success getting mixpanel id from CLHID" +  objReturn.CLHID;
        objReturn.analyticsID = objReturnID.analyticsID;
        objReturn.rtnstack.push(objReturnID);
        ...
        getMixpanelDataPromise.then(
          function (objReturnData){
            ...
            dbg("resolving getMixPanelData successfully",1);
  
            var objReturn = {"rtn":"error", "rtnmsg":"unknown error","rtnstack":[]};
            objReturn.rtn = "ok";
            objReturn.rtnmsg = "success getting mixpanel events for CLHID" +  objReturn.CLHID;
          ...
          function (objRejectData) {
            dbg(objRejectData,2);
            objReturn.rtnstack.push(objRejectData);
            objReturn.rtn="error";
